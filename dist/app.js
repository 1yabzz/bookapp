(function () {
    ...
    */
    ...
    class CardList extends Divcomp{
    ...
    class MainView extends AbsView{
        ...
        render(){
            const main = document.createElement('div');
            main.innerHTML = `<h1>
        Найдено книг - ${this.state.numFound}</h1>
        `;
